...
export default function SettingsPage() {
  const { shopName, shopLogoUrl, shopAddress, currencySymbol, updateSettings, isSettingsLoaded } = useSettings();
  ...
  }, [isSettingsLoaded, shopName, shopLogoUrl, shopAddress, currencySymbol, reset]);
  ...
  return (
    <div className="container mx-auto py-4">
      <header className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your shop details and application preferences.</p>
      </header>
